#include <cmath>
#include <iostream>
// Jacob Agbata, Zeyad Eltemsah, We pledge our honor that we abidided by the
// Stevens Honor system. We also got help from Cesar Espejo and Xavion McClary
using namespace std;
...
void range_reverse(int x[], int n, int a,
                   int b)  // this function does not seem to work properly, we
